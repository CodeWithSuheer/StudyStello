        ...
        <>
            ...
            >
                <div className="flex flex-col min-h-screen bg-black/60">
                    <div className="container flex flex-col flex-1 px-3 lg:px-10 py-24 lg:py-16 mx-auto">
                        <div className="flex-1 lg:flex lg:items-center lg:-mx-6">
                            ...
                            <div className="text-white lg:w-1/2 lg:mx-6">
                                ...
                                <p className="max-w-lg mt-6">
                                    Communicate with our friendly customer care center and get an immediate response within seconds. Our 24/7 online live chat support is ready to assist you.
                                </p>
                                <button onClick={() => { Tawk_API.toggle(); }} className="px-8 py-3 mt-6 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-600 rounded-md hover:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-400 focus:ring-opacity-50">
                                    get in touch
                                </button>
                            ...
                            <div className="mt-8 lg:w-1/2 lg:mx-6">
                                <div className="w-full px-4 sm:px-8 py-10 mx-auto overflow-hidden bg-white shadow-2xl rounded-xl dark:bg-gray-900 lg:max-w-xl">
